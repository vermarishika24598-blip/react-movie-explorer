...
export default function Watchlist() {
  ...
  // ✨ Beautiful Empty State (Agar watchlist khali ho)
  if (!watchlist || !watchlist.length) {
    return (
      <div className="bg-neutral-950 min-h-screen text-neutral-400 flex flex-col items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="text-6xl mb-4 text-neutral-600 animate-bounce">📌</div>
        <h3 className="text-white text-xl font-bold mb-1">Your Watchlist is Empty</h3>
        <p className="text-neutral-500 text-sm text-center max-w-xs">
          Explore movies and save them here to keep track of what you want to watch next!
        </p>
      </div>
    );
  }
